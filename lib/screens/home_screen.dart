  ...
  Future<void> _loadMovies() async {
    ...
    try {
      ...
      if (movieService.popularMovies.isNotEmpty) {
        await movieService
            .fetchRecommendations(movieService.popularMovies.first.id);
      }
    } catch (e) {
      setState(() {
                              ...
                              child: Row(
                                ...
                                children: List.generate(
                                  ...
                                  (index) => Container(
                                    ...
                                    width:
                                        index == _currentBannerIndex ? 24 : 8,
                                    height: 8,
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ListView.builder(
                                  ...
                                  padding: EdgeInsets.symmetric(horizontal: 8),
                                  itemCount:
                                      movieService.recommendations.length,
                                  itemBuilder: (context, index) {
                                    final movie =
                                        movieService.recommendations[index];
                                    return GestureDetector(
                                      onTap: () {
                                        Navigator.push(
                                          context,
